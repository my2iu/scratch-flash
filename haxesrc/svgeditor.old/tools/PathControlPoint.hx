...
{
    private static inline var h_fill : Int = 0xDDDDDD;  // highlight version  
    private static inline var fill : Int = 0xCCFF33;
    ...
    public function new(editTool : PathEditTool, idx : Int, first : Bool)
    {
        super();
