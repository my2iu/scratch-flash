...
@:final class PaintBucketTool extends SVGTool
{
    ...
    private function bitmapFloodFill(bm : BitmapData, fillX : Int, fillY : Int) : Void{
        var markerC : Int = 0xFFFF00FF;  // special color used to mark pixels to be filled  
        
        var tmp : BitmapData = new BitmapData(bm.width, bm.height, true, 0);
        var targetC : Int = bm.getPixel32(fillX, fillY);
        var tMask : Int = toleranceMask();
    ...
    private function toleranceMask() : Int{
