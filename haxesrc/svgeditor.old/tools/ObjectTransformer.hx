...
class ObjectTransformer extends SVGEditTool
{
    ...
    private static inline var grpDashLength : Int = 3;
    private static inline var grpDashColor : Int = 0xfb9b00;
    private static inline var bmDashLength : Int = 4;
    private static inline var bmDashColor : Int = 0x0000FF;
    private static inline var resizeColor : Int = 0x000000;
    private static inline var rotateColor : Int = 0x666666;
    private static inline var moveColor : Int = 0x00CC00;
    
    // Pseudo enum for handle types
    private static inline var HT_RESIZER : Int = 0;
    private static inline var HT_ROTATOR : Int = 1;
    private static inline var HT_MOVER : Int = 2;
    ...
    private function showUI() : Void{
        ...
        // Draw the dashed box
        var dLen : Int = ((targetObj.isGroup()) ? grpDashLength : (targetObj.isImage()) ? bmDashLength : dashLength);
        var dCol : Int = ((targetObj.isGroup()) ? grpDashColor : (targetObj.isImage()) ? bmDashColor : dashColor);
