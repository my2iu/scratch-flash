...
class PixelPerfectCollisionDetection
{
    ...
    public static function isColliding(target1 : DisplayObject, target2 : DisplayObject, sensitive : Bool = false, debugSpr : Sprite = null) : Bool
    {
    ...
    public static function areaOfCollision(object1 : DisplayObject, object2 : DisplayObject, sensitive : Bool = false, debugSpr : Sprite = null) : Rectangle{
