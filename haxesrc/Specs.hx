...
class Specs
{
    ...
    public static inline var GET_LIST : String = "contentsOfList:";
    ...
    public static inline var controlCategory : Int = 6;
    public static inline var operatorsCategory : Int = 8;
    public static inline var dataCategory : Int = 9;
