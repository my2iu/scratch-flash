...
class SVGDisplayRender
{
    
    private var svgSprite : Sprite;
    private var currentShape : Shape;
    private var forHitTest : Bool;
    
    public function renderAsSprite(rootSVG : SVGElement, doShift : Bool = false, forHitTest : Bool = false) : Sprite{
        ...
        if (doShift) {
            ...
            if ((r.x != 0) || (r.y != 0)) {
                ...
                for (i in 0...svgSprite.numChildren){
