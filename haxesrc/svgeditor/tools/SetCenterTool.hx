...
@:final class SetCenterTool extends SVGTool
{
    ...
    private function mouseUp(e : MouseEvent) : Void{
        var canvas : ImageCanvas = editor.getWorkArea();
        var ox : Float = ImageCanvas.canvasWidth / 2 - canvas.getVisibleLayer().mouseX;
        var oy : Float = ImageCanvas.canvasHeight / 2 - canvas.getVisibleLayer().mouseY;
