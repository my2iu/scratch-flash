...
class PathEndPoint extends Sprite
{
    private var editor : ImageEdit;
    private var shape : SVGShape;
    private var strokeWidth : Float;
    public function new(ed : ImageEdit, a : SVGShape, p : Point)
    {
        super();
        editor = ed;
        shape = a;
    ...
    private function showOrb(e : MouseEvent) : Void{
        var w : Float = (strokeWidth + shape.getElement().getAttribute("stroke-width", 1)) / 4;
